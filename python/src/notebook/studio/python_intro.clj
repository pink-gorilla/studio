(ns notebook.studio.python-intro
  (:require
   [libpython-clj.python :as py :refer [as-python as-jvm ->python ->jvm
                                        py. py.. py.-
   ...
   [libpython-clj.metadata :refer [doc]]
   [pinkgorilla.python.core :refer [py-initialize!]]))

;;; # Initialization
;;; This dynamically finds the python shared library and loads it using output from the python3 executable on your system. 
